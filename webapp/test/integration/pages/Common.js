sap.ui.define([
	...
	return Opa5.extend("com.mass.compchange.zmasscomponentchange.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/mass/compchange/zmasscomponentchange/localService/mockserver"], function (mockserver) {
