sap.ui.define([
	"sap/ui/test/Opa5",
	"com/mass/compchange/zmasscomponentchange/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel",
	"sap/ui/core/routing/HashChanger",
	"com/mass/compchange/zmasscomponentchange/test/flpSandbox",
	"sap/ui/fl/FakeLrepConnectorLocalStorage"
], function(Opa5, mockserver, ODataModel, HashChanger, flpSandbox, FakeLrepConnectorLocalStorage) {
	"use strict";

	return Opa5.extend("com.mass.compchange.zmasscomponentchange.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "MaterialBOM/" + encodeURIComponent(sObjectId);
