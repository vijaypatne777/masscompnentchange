		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mass Component Change",
									"targetURL": "#MassComponentChange-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MassComponentChange-display": {
								"semanticObject": "MassComponentChange",
								"action": "display",
								"description": "Mass Component Change",
								"title": "Mass Component Change",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mass.compchange.zmasscomponentchange",
									"url": sap.ui.require.toUrl("com/mass/compchange/zmasscomponentchange")
								}
							}
						}
					}
